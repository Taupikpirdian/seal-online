  ...
  <div class="layout-content-4 layout-item-1-3 grid-limit content-box-style">
      ...
      <div class="account-info-wrap">
        ...
        <div class="account-info-stats">
          <div class="account-info-stat">
            <p class="account-info-stat-value">69</p>

            <p class="account-info-stat-title">Comments</p>
          </div>

          <div class="account-info-stat">
            <p class="account-info-stat-value">165</p>

            <p class="account-info-stat-title">Likes RCV</p>
          </div>

          <div class="account-info-stat">
            <p class="account-info-stat-value">5</p>

            <p class="account-info-stat-title">Orders</p>
          </div>
        </div>
    ...
    <div class="layout-body">
      <div class="section-title-wrap blue">
        <h2 class="section-title medium">Change Email</h2>
      ...
      <form class="account-settings-form">
        <div class="form-row">
          <div class="form-item half blue">
            <label for="as_first_name" class="rl-label">New Email</label>
            <input type="text" id="as_email" name="as_email" placeholder="Enter your email here..." value="jspiegel@yourmail.com">
          </div>

          <div class="form-item half blue">
            <label for="as_first_name" class="rl-label">User Name</label>
            <input type="text" id="as_first_name" name="as_first_name" placeholder="Enter your user name here...">
          </div>
         
        </div>
        <div class="form-row">
         <div class="form-item half blue">
            <label for="as_pwd_repeat" class="rl-label">Password</label>
            <input type="password" id="as_pwd_repeat" name="as_pwd_repeat" placeholder="Enter your Password here...">
          </div>
           <div class="form-item half blue">
