  ...
  <div id="contents" class="">
    ...
    <div id="contents_center2">
      <article id="party_body" class="guide_body">
        <div id="topicpath">
          <ol>
            <li><a><span itemprop='title'>HOME</span></a></li><li><a><span itemprop='title'>Ranking</span></a></li><li>Fame Ranking</li></ol>
        </div>
        ...
        <div class="box" id="guide-section">
          ...
          <div class="widget-item">
            <div class="section-title-wrap blue small-space">
              <p class="section-title medium">Fame Ranking</p>
            ...
            <div class="table standings full">
              ...
              @foreach ($pcs as $key => $pc)
                ...
                <div class="table-row">
                  ...
                  <div class="table-row-item">
                    <div class="team-info">
                      <p class="table-text bold">{{ $pc->char_name }}</p>
                    </div>
                  </div>
        
                  <div class="table-row-item">
                    <p class="table-text bold">{{ $pc->fame }}</p>
                  </div>
                </div>
              @endforeach
            </div>
