...
@section('content')
  <div class="banner-wrap e-sport">
    <div class="banner grid-limit">
      <h2 class="banner-title">Ranking Top Kill</h2>
      <p class="banner-sections">
        <span class="banner-section">Home</span>
        <svg class="arrow-icon">
          <use xlink:href="#svg-arrow"></use>
        </svg>
        <span class="banner-section">List Ranking Top Kill</span>
        <svg class="arrow-icon">
          <use xlink:href="#svg-arrow"></use>
        </svg>
        <span class="banner-section">Informasi Ranking - Top Kill</span>
      </p>
    </div>
  </div>
    ...
    <div class="layout-body layout-item gutter-big">
      <div class="widget-item">
        <div class="section-title-wrap blue small-space">
          <h2 class="section-title medium">Top Kill Ranking</h2>
        ...
        <div class="table standings full">
          <div class="table-row-header">
            ...
            {{-- <div class="table-row-header-item table-style padded">
              <p class="table-row-header-title">Nama Top Kill</p>
            </div> --}}
          ...
          @foreach ($top_kills as $key => $top_kill)
            ...
            <div class="table-row">
              ...
              <div class="table-row-item">
                <div class="team-info">
                  <p class="table-text bold">{{ $top_kill->char_name }}</p>
                </div>
              </div>
    
              {{-- <div class="table-row-item">
                <p class="table-text bold">{{ $top_kill->couple_name }}</p>
              </div> --}}
