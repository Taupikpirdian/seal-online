...
@section('content')
  <div class="content-w">  
    ...
    <ul class="breadcrumb">
      ...
      <li class="breadcrumb-item">
        <a href="{{URL::to('/event/index')}}">List Event</a>
      </li>
      <li class="breadcrumb-item">
        ...
        <div class="col-lg-12">
          <div class="element-wrapper">
            ...
            <div class="element-box">
              {!! Form::model($event,['method'=>'put', 'files'=>'true', 'action'=>['Admin\EventController@update',$event->id]]) !!}
                ...
                <div class="form-group clearfix {{ ($errors->first('img')) ? 'has-error has-danger' : '' }}">
                  ...
                  <div class='col-md-12'>
                    ...
                    <img src="{{ asset('/images/event/'.$event->img)}}" style="max-height:100px;max-width:100px;margin-top:10px;">
                  </div>
                </div>
