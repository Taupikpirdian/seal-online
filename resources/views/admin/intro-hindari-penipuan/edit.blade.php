...
@section('content')
  <div class="content-w">  
    ...
    <ul class="breadcrumb">
      ...
      <li class="breadcrumb-item">
        <a href="{{URL::to('/hindari-penipuan/index')}}">List Intro</a>
      </li>
      <li class="breadcrumb-item">
        ...
        <div class="col-lg-12">
          <div class="element-wrapper">
            ...
            <div class="element-box">
            	{!! Form::model($hindari_penipuan,['method'=>'put', 'files'=>'true', 'action'=>['Admin\IntroHindariPenipuanController@update',$hindari_penipuan->id]]) !!}
