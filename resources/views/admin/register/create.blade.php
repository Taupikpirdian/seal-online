...
@section('content')
  <div class="content-w">  
    ...
    <ul class="breadcrumb">
      ...
      <li class="breadcrumb-item">
        <a href="{{URL::to('/intro/index')}}">List Konten Register</a>
      </li>
      <li class="breadcrumb-item">
        <span>Create Konten Register</span>
      </li>
    </ul>
    <!--------------------
    END - Breadcrumbs
        ...
        <div class="col-lg-12">
          <div class="element-wrapper">
            <h6 class="element-header">
              Create Konten Register
            </h6>
            <div class="element-box">
              {!! Form::open(['action' => 'Admin\ContentRegisterController@store', 'files' => 'true']) !!}
