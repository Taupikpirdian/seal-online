        ...
        <div class="col-lg-12">
          <div class="element-wrapper">
            ...
            <div class="element-box">
            	{!! Form::model($background,['method'=>'put', 'files'=>'true', 'action'=>['Admin\BackgroundController@update',$background->id]]) !!}
                ...
                <div class="form-group clearfix {{ ($errors->first('img')) ? 'has-error has-danger' : '' }}">
                  ...
                  <div class='col-md-12'>
                    ...
                    <img src="{{ asset('/images/background/'.$background->img)}}" style="max-height:100px;max-width:100px;margin-top:10px;">
                  </div>
                </div>
