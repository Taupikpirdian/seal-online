...
@section('content')
  <div class="content-w">  
    ...
    <ul class="breadcrumb">
      ...
      <li class="breadcrumb-item">
        <a href="{{URL::to('/contact-us/index')}}">List Content</a>
      </li>
      <li class="breadcrumb-item">
        ...
        <div class="col-lg-12">
          <div class="element-wrapper">
            ...
            <div class="element-box">
            	{!! Form::model($contact_us,['method'=>'put', 'files'=>'true', 'action'=>['Admin\ContactUsController@update',$contact_us->id]]) !!}
                ...
                <div class="form-group clearfix {{ ($errors->first('contact_info')) ? 'has-error has-danger' : '' }}">
                  {{ Form::label("contact_info", "Contact Info", ['class' => 'col-md-2 control-label']) }}
                  <div class='col-md-12'>
                    {{ Form::text("contact_info", null,['class' => 'form-control required', 'value' => (old('contact_info')) ? old('contact_info') : '', 'placeholder' => 'Masukan Email/No Contact']) }}
