...
@section('content')
  <div class="content-w">  
    ...
    <ul class="breadcrumb">
      ...
      <li class="breadcrumb-item">
        <a href="{{URL::to('/contact-us/index')}}">Contact Us</a>
      </li>
      <li class="breadcrumb-item">
        <span>Create Contact Us</span>
      </li>
    </ul>
    <!--------------------
    END - Breadcrumbs
        ...
        <div class="col-lg-12">
          <div class="element-wrapper">
            ...
            <div class="element-box">
              {!! Form::open(['action' => 'Admin\ContactUsController@store', 'files' => 'true']) !!}
                ...
                <div class="form-group clearfix {{ ($errors->first('contact_info')) ? 'has-error has-danger' : '' }}">
                  ...
                  <div class='col-md-12'>
                    {{ Form::text("contact_info", '',['class' => 'form-control required', 'value' => (old('contact_info')) ? old('contact_info') : '', 'placeholder' => 'Masukan Email/No Contact']) }}
