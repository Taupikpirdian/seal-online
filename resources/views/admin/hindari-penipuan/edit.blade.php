...
@section('content')
  <div class="content-w">  
    ...
    <ul class="breadcrumb">
      ...
      <li class="breadcrumb-item">
        <a href="{{URL::to('/hindari-penipuan/index')}}">List Penipuan</a>
      </li>
      <li class="breadcrumb-item">
        <span>Edit Penipuan</span>
      </li>
    </ul>
    <!--------------------
    END - Breadcrumbs
        ...
        <div class="col-lg-12">
          <div class="element-wrapper">
            ...
            <div class="element-box">
            	{!! Form::model($hindari_penipuan,['method'=>'put', 'files'=>'true', 'action'=>['Admin\HindariPenipuanController@update',$hindari_penipuan->id]]) !!}
