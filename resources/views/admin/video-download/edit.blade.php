...
@section('content')
  <div class="content-w">  
    ...
    <ul class="breadcrumb">
      ...
      <li class="breadcrumb-item">
        <a href="{{URL::to('/video-download/index')}}">List Video</a>
      </li>
      <li class="breadcrumb-item">
        ...
        <div class="col-lg-12">
          <div class="element-wrapper">
            ...
            <div class="element-box">
            	{!! Form::model($video_download,['method'=>'put', 'files'=>'true', 'action'=>['Admin\VideoDownloadController@update',$video_download->id]]) !!}

                <div class="form-group clearfix {{ ($errors->first('name')) ? 'has-error has-danger' : '' }}">
                  {{ Form::label("title", "Judul", ['class' => 'col-md-2 control-label']) }}
                  <div class='col-md-12'>
                    {{ Form::text("title", null,['class' => 'form-control required', 'value' => (old('title')) ? old('title') : '', 'required' => 'required']) }}
                ...
                <div class="form-group clearfix {{ ($errors->first('video_name')) ? 'has-error has-danger' : '' }}">
                  ...
                  <div class='col-md-12'>
                    {{ Form::text("video_name", null,['class' => 'form-control required', 'value' => (old('video_name')) ? old('video_name') : '', 'required' => 'required']) }}
                ...
                <div class="form-group clearfix {{ ($errors->first('name')) ? 'has-error has-danger' : '' }}">
                  ...
                  <div class='col-md-12'>
                    {{ Form::text("url", null,['class' => 'form-control required', 'value' => (old('url')) ? old('url') : '', 'required' => 'required', 'placeholder' => 'Contoh: http://www.youtube.com/embed/W7qWa52k-nE']) }}
                ...
                <div class="form-group clearfix {{ ($errors->first('name')) ? 'has-error has-danger' : '' }}">
                  ...
                  <div class='col-md-12'>
                    {{ Form::number("size", null,['class' => 'form-control required', 'value' => (old('size')) ? old('size') : '', 'required' => 'required']) }}
