...
@section('content')
  <div class="content-w">  
    ...
    <ul class="breadcrumb">
      ...
      <li class="breadcrumb-item">
        <a href="{{URL::to($url)}}">Update Seal - {{ $title }}</a>
      </li>
      <li class="breadcrumb-item">
        <span>Edit Update Seal - {{ $title }}</span>
      </li>
    </ul>
    <!--------------------
    END - Breadcrumbs
        ...
        <div class="col-lg-12">
          <div class="element-wrapper">
            <h6 class="element-header">
              Edit Update Seal - {{ $title }}
            </h6>
            <div class="element-box">
            	{!! Form::model($data,['method'=>'put', 'files'=>'true', 'action'=>['Admin\UpdateSealPartController@update',$data->id]]) !!}
                ...
                <div class="form-group clearfix {{ ($errors->first('sub_category')) ? 'has-error has-danger' : '' }}">
                ...
                <div class="form-group clearfix {{ ($errors->first('img')) ? 'has-error has-danger' : '' }}">
                  ...
                  <div class='col-md-12'>
                    ...
                    <img src="{{ asset('/images/update-part/'.$data->img)}}" style="max-height:100px;max-width:100px;margin-top:10px;">
                  </div>
                </div>
