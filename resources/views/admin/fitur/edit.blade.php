        ...
        <div class="col-lg-12">
          <div class="element-wrapper">
            ...
            <div class="element-box">
            	{!! Form::model($fitur,['method'=>'put', 'files'=>'true', 'action'=>['Admin\FiturController@update',$fitur->id]]) !!}
                ...
                <div class="form-group clearfix {{ ($errors->first('img')) ? 'has-error has-danger' : '' }}">
                  ...
                  <div class='col-md-12'>
                    ...
                    <img src="{{ asset('/images/fitur/'.$fitur->img)}}" style="max-height:100px;max-width:100px;margin-top:10px;">
                  </div>
                </div>
