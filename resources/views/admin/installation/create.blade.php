...
@section('content')
  <div class="content-w">  
    ...
    <ul class="breadcrumb">
      ...
      <li class="breadcrumb-item">
        <a href="{{URL::to('/installation/index')}}">List Installation</a>
      </li>
      <li class="breadcrumb-item">
        ...
        <div class="col-lg-12">
          <div class="element-wrapper">
            ...
            <div class="element-box">
              {!! Form::open(['action' => 'Admin\InstallationController@store', 'files' => 'true']) !!}

                <div class="form-group clearfix {{ ($errors->first('intro')) ? 'has-error has-danger' : '' }}">
                  {{ Form::label("intro", "Intro", ['class' => 'col-md-2 control-label']) }}
                  <div class='col-md-12'>
                    {{ Form::textarea("intro", '',['class' => 'form-control required', 'value' => (old('intro')) ? old('intro') : '', 'id' => 'editor' ]) }}
                ...
                <div class="form-group clearfix {{ ($errors->first('spec')) ? 'has-error has-danger' : '' }}">
                  ...
                  <div class='col-md-12'>
                    {{ Form::textarea("spec", '',['class' => 'form-control required', 'value' => (old('spec')) ? old('spec') : '', 'id' => 'editor2' ]) }}
                ...
                <div class="form-group clearfix {{ ($errors->first('step_by_step')) ? 'has-error has-danger' : '' }}">
                  ...
                  <div class='col-md-12'>
                    {{ Form::textarea("step_by_step", '',['class' => 'form-control required', 'value' => (old('step_by_step')) ? old('step_by_step') : '', 'id' => 'editor3' ]) }}
