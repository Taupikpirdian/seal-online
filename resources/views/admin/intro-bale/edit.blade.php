        ...
        <div class="col-lg-12">
          <div class="element-wrapper">
            ...
            <div class="element-box">
            	{!! Form::model($intro,['method'=>'put', 'files'=>'true', 'action'=>['Admin\BaleMonsterController@updateIntro',$intro->id]]) !!}
                ...
                <div class="form-group clearfix {{ ($errors->first('tag_line')) ? 'has-error has-danger' : '' }}">
                  ...
                  <div class='col-md-12'>
                    {{ Form::select('category', $category, $intro->type,['class' => 'form-control select2 required', 'placeholder' => 'Pilih Kategori']) }}
