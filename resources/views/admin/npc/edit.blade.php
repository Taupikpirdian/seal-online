        ...
        <div class="col-lg-12">
          <div class="element-wrapper">
            ...
            <div class="element-box">
            	{!! Form::model($data,['method'=>'put', 'files'=>'true', 'action'=>['Admin\NonPlayerCharacterController@update',$data->id]]) !!}
                ...
                <div class="form-group clearfix {{ ($errors->first('img')) ? 'has-error has-danger' : '' }}">
                  ...
                  <div class='col-md-12'>
                    ...
                    <img src="{{ asset('/images/npc/'.$data->img)}}" style="max-height:100px;max-width:100px;margin-top:10px;">
                  </div>
                </div>
