...
@section('content')
  <div class="content-w">  
    ...
    <ul class="breadcrumb">
      ...
      <li class="breadcrumb-item">
        <a href="{{URL::to('/emotikon-download/index')}}">List Emotikon</a>
      </li>
      <li class="breadcrumb-item">
        <span>Edit Emotikon</span>
      </li>
    </ul>
    <!--------------------
    END - Breadcrumbs
        ...
        <div class="col-lg-12">
          <div class="element-wrapper">
            ...
            <div class="element-box">
            	{!! Form::model($emotikon_download,['method'=>'put', 'files'=>'true', 'action'=>['Admin\EmotikonDownloadController@update',$emotikon_download->id]]) !!}
                ...
                <div class="form-group clearfix {{ ($errors->first('img')) ? 'has-error has-danger' : '' }}">
                  ...
                  <div class='col-md-12'>
                    ...
                    <img src="{{ asset('/images/emotikon/'.$emotikon_download->img)}}" style="max-height:100px;max-width:100px;margin-top:10px;">
