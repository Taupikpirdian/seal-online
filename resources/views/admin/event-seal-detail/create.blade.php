...
@section('content')
  <div class="content-w">  
    ...
    <ul class="breadcrumb">
      ...
      <li class="breadcrumb-item">
        <a href="{{URL::to('/event-seal/show/'.$id)}}">List Event Seal List</a>
      </li>
      <li class="breadcrumb-item">
        <span>Create Event Seal List</span>
      </li>
    </ul>
    <!--------------------
    END - Breadcrumbs
        ...
        <div class="col-lg-12">
          <div class="element-wrapper">
            <h6 class="element-header">
              Create Event Seal List
            </h6>
            <div class="element-box">
            	{!! Form::model($id,['method'=>'post', 'files'=>'true', 'action'=>['Admin\EventSealListController@store',$id]]) !!}
