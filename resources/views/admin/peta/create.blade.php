        ...
        <div class="col-lg-12">
          <div class="element-wrapper">
            ...
            <div class="element-box">
              {!! Form::open(['action' => 'Admin\PetaController@store', 'files' => 'true']) !!}
               ...
               <div class="form-group clearfix {{ ($errors->first('category')) ? 'has-error has-danger' : '' }}">
                  ...
                  <div class='col-md-12'>
                    <select name="category" id="" class="form-control">
                      <option value="0">Peta Dunia Shilzt</option>
                      <option value="1">Kota Dunia Shilzt</option>
                    </select>
