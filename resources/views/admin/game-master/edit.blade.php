        ...
        <div class="col-lg-12">
          <div class="element-wrapper">
            ...
            <div class="element-box">
            	{!! Form::model($game_master,['method'=>'put', 'files'=>'true', 'action'=>['Admin\GameMasterController@update',$game_master->id]]) !!}
                
                <div class="form-group clearfix {{ ($errors->first('nama')) ? 'has-error has-danger' : '' }}">
                  {{ Form::label("nama", "Nama", ['class' => 'col-md-2 control-label']) }}
                  <div class='col-md-12'>
                    {{ Form::text("nama", null,['class' => 'form-control required', 'value' => (old('nama')) ? old('nama') : '' ]) }}
                ...
                <div class="form-group clearfix {{ ($errors->first('umur')) ? 'has-error has-danger' : '' }}">
                  ...
                  <div class='col-md-12'>
                    {{ Form::text("umur", null,['class' => 'form-control required', 'value' => (old('umur')) ? old('umur') : '' ]) }}
                ...
                <div class="form-group clearfix {{ ($errors->first('alamat')) ? 'has-error has-danger' : '' }}">
                  ...
                  <div class='col-md-12'>
                    {{ Form::text("alamat", null,['class' => 'form-control required', 'value' => (old('alamat')) ? old('alamat') : '' ]) }}
                ...
                <div class="form-group clearfix {{ ($errors->first('hobi')) ? 'has-error has-danger' : '' }}">
                  ...
                  <div class='col-md-12'>
                    {{ Form::text("hobi", null,['class' => 'form-control required', 'value' => (old('hobi')) ? old('hobi') : '' ]) }}
                ...
                <div class="form-group clearfix {{ ($errors->first('favorit_pet')) ? 'has-error has-danger' : '' }}">
                  ...
                  <div class='col-md-12'>
                    {{ Form::text("favorit_pet", null,['class' => 'form-control required', 'value' => (old('favorit_pet')) ? old('favorit_pet') : '' ]) }}
                ...
                <div class="form-group clearfix {{ ($errors->first('favorit_warna')) ? 'has-error has-danger' : '' }}">
                  ...
                  <div class='col-md-12'>
                    {{ Form::text("favorit_warna", null,['class' => 'form-control required', 'value' => (old('favorit_warna')) ? old('favorit_warna') : '' ]) }}
                ...
                <div class="form-group clearfix {{ ($errors->first('reputasi')) ? 'has-error has-danger' : '' }}">
                  ...
                  <div class='col-md-12'>
                    {{ Form::text("reputasi", null,['class' => 'form-control required', 'value' => (old('reputasi')) ? old('reputasi') : '' ]) }}
                ...
                <div class="form-group clearfix {{ ($errors->first('motto')) ? 'has-error has-danger' : '' }}">
                  ...
                  <div class='col-md-12'>
                    {{ Form::text("motto", null,['class' => 'form-control required', 'value' => (old('motto')) ? old('motto') : '' ]) }}
