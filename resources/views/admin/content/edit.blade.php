...
@section('content')
  <div class="content-w">  
    ...
    <ul class="breadcrumb">
      ...
      <li class="breadcrumb-item">
        <a href="{{URL::to('/content/index')}}">List Content</a>
      </li>
      <li class="breadcrumb-item">
        ...
        <div class="col-lg-12">
          <div class="element-wrapper">
            ...
            <div class="element-box">
            	{!! Form::model($content,['method'=>'put', 'files'=>'true', 'action'=>['Admin\ContenController@update',$content->id]]) !!}
                ...
                <div class="form-group clearfix {{ ($errors->first('img')) ? 'has-error has-danger' : '' }}">
                  ...
                  <div class='col-md-12'>
                    ...
                    <img src="{{ asset('/images/content/'.$content->img)}}" style="max-height:100px;max-width:100px;margin-top:10px;">
                  </div>
                </div>
