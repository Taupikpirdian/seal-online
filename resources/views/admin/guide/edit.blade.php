...
@section('content')
  <div class="content-w">  
    ...
    <ul class="breadcrumb">
      ...
      <li class="breadcrumb-item">
        <a href="{{URL::to('/guide/index')}}">List Guide</a>
      </li>
      <li class="breadcrumb-item">
        ...
        <div class="col-lg-12">
          <div class="element-wrapper">
            ...
            <div class="element-box">
            	{!! Form::model($guide,['method'=>'put', 'files'=>'true', 'action'=>['Admin\GuideController@update',$guide->id]]) !!}
                ...
                <div class="form-group clearfix {{ ($errors->first('informasi_quest')) ? 'has-error has-danger' : '' }}">
                  ...
                  <div class='col-md-12'>
                    {{ Form::textarea("informasi_quest", null,['class' => 'form-control required', 'value' => (old('informasi_quest')) ? old('informasi_quest') : '', 'id' => 'editor2']) }}
                ...
                <div class="form-group clearfix {{ ($errors->first('img')) ? 'has-error has-danger' : '' }}">
                  ...
                  <div class='col-md-12'>
                    ...
                    <img src="{{ asset('/images/guide/'.$guide->img)}}" style="max-height:100px;max-width:100px;margin-top:10px;">
                  </div>
                </div>
