        ...
        <div class="col-lg-12">
          <div class="element-wrapper">
            ...
            <div class="element-box">
            	{!! Form::model($buttonHome,['method'=>'put', 'files'=>'true', 'action'=>['Admin\HomeButtonController@update',$buttonHome->id]]) !!}
              ...
              <div class="form-group clearfix {{ ($errors->first('caption')) ? 'has-error has-danger' : '' }}">
                  ...
                  <div class='col-md-12'>
                    {{ Form::text("caption", null,['class' => 'form-control', 'value' => (old('caption')) ? old('caption') : '']) }}
                ...
                <div class="form-group clearfix {{ ($errors->first('link')) ? 'has-error has-danger' : '' }}">
                  ...
                  <div class='col-md-12'>
                    {{ Form::text("link", null,['class' => 'form-control', 'value' => (old('link')) ? old('link') : '']) }}
                ...
                <div class="form-group clearfix {{ ($errors->first('img')) ? 'has-error has-danger' : '' }}">
                  ...
                  <div class='col-md-12'>
                    ...
                    <img src="{{ asset('/images/button-home/'.$buttonHome->img)}}" style="max-height:100px;max-width:100px;margin-top:10px;">
                  </div>
                </div>
                    ...
                    <label for="user_group">Position</label>
                      <div class="form-group">
                        <select name="position" class="form-control">
                          ...
                          <option value="left" @if($buttonHome->position == "left") selected @endif> Left </option>
                          <option value="right" @if($buttonHome->position == "right") selected @endif> Right </option>
                        </select>
                      </div>
                      @error('position')
                    ...
                    <label for="user_group">Status</label>
                      <div class="form-group">
                        <select name="status" class="form-control">
                          ...
                          <option value="publish" @if($buttonHome->status == "publish") selected @endif> Publish </option>
                          <option value="draf" @if($buttonHome->status == "draf") selected @endif> Draf </option>
                        </select>
                      </div>
                      @error('position')
                        <div class="mt-2 text-danger">{{ $message }}</div>
