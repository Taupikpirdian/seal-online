...
@section('content')
  <div class="content-w">  
    ...
    <ul class="breadcrumb">
      ...
      <li class="breadcrumb-item">
        <a href="{{URL::to('/download/index')}}">Download</a>
      </li>
      <li class="breadcrumb-item">
        <span>Edit Download Part</span>
      </li>
    </ul>
    <!--------------------
    END - Breadcrumbs
        ...
        <div class="col-lg-12">
          <div class="element-wrapper">
            ...
            <div class="element-box">
            	{!! Form::model($data,['method'=>'put', 'files'=>'true', 'action'=>['Admin\PartDownloadController@update',$data->id]]) !!}
                
                <div class="form-group clearfix {{ ($errors->first('part')) ? 'has-error has-danger' : '' }}">
                  {{ Form::label("part", "Part Ke", ['class' => 'col-md-2 control-label']) }}
                  <div class='col-md-12'>
                    {{ Form::text("part", null,['class' => 'form-control required', 'value' => (old('part')) ? old('part') : '' ]) }}
