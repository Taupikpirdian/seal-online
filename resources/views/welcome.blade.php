...
<html lang="en">
  <head>
    ...
    <style>
      /* body{
        background: url('../../front/background.jpg') no-repeat;
  ...
  <body @if($setup) style="
    background: url({{ asset('/images/setup/'.$setup->background) }});
    background-size: cover;
    ...
    <section class="welcome__content">
      <div class="container header">
        ...
        <div class="row mt-5 mb-5 text-center content">
          ...
          <div class="row footer mt-5">
            <div class="col text-center">
              <a href="#" class="btn btn-primary text-uppercase">web sedang dalam maintenance</a>
            </div>
          </div>
          @endif
        @endif
