  ...
  <div class="layout-content-4 layout-item-1-3 grid-limit content-box-style">
    <div class="layout-sidebar">
      <div class="account-info-wrap">
        ...
        <div class="account-info-stats">
          ...
          <div class="account-info-stat">
            <p class="account-info-stat-value">14 Feb 2020 18:13:48</p>

            <p class="account-info-stat-title">Last Login</p>
          </div>
        </div>
    ...
    <div class="layout-body">
      <div class="section-title-wrap blue">
        <h2 class="section-title medium">Change Password</h2>
      ...
      <form class="account-settings-form">
          ...
          <div class="form-item half blue">
            ...
            <input type="password" id="as_pwd" name="as_pwd" placeholder="Enter your old password here...">
          </div>

          <div class="form-item half blue">
            <label for="as_pwd_repeat" class="rl-label">New Password</label>
            <input type="password" id="as_pwd_repeat" name="as_pwd_repeat" placeholder="your new password here...">
          </div>
         
        </div>
        <div class="form-row">
         <div class="form-item half blue">
            <label for="as_pwd_repeat" class="rl-label">Confrim New Password</label>
            <input type="password" id="as_pwd_repeat" name="as_pwd_repeat" placeholder="Confrim your new password here...">
          </div>
           <div class="form-item half blue">
